...
clear_set_button = tk.Button(
    table, text="Clear Set", font=button_font, command=game.clear_set
)

clear_table_button = tk.Button(
    table, text="Clear Table", font=button_font, command=game.clear_table
)
...
clear_set_button.place(x=700, y=150)
clear_table_button.place(x=700, y=200)
